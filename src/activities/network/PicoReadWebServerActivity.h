...
#include "network/PicoReadWebServer.h"
...
/**
 * PicoReadWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the PicoReadWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class PicoReadWebServerActivity final : public Activity {
  ...
  std::unique_ptr<PicoReadWebServer> webServer;
 ...
 public:
  explicit PicoReadWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("PicoReadWebServer", renderer, mappedInput) {}
