#include "PicoReadWebServerActivity.h"
...
constexpr const char* AP_SSID = "PicoRead-Reader";
constexpr const char* AP_PASSWORD = nullptr;  // Open network for ease of use
constexpr const char* AP_HOSTNAME = "picoread";
...
void PicoReadWebServerActivity::onEnter() {
  Activity::onEnter();
...
void PicoReadWebServerActivity::onExit() {
  Activity::onExit();
...
void PicoReadWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void PicoReadWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void PicoReadWebServerActivity::startAccessPoint() {
...
void PicoReadWebServerActivity::startWebServer() {
...
void PicoReadWebServerActivity::render(RenderLock&&) {
...
void PicoReadWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
...
void PicoReadWebServerActivity::renderWifiIndicator(int subHeaderTop) const {
