...
XtcReaderActivity::StatusBarInfo XtcReaderActivity::getStatusBarInfo() const {
  ...
  std::string title =
      SETTINGS.statusBarTitle == PicoReadSettings::STATUS_BAR_TITLE::BOOK_TITLE ? xtc->getTitle() : "";
  ...
  if (SETTINGS.statusBarTitle == PicoReadSettings::STATUS_BAR_TITLE::CHAPTER_TITLE) {
...
void XtcReaderActivity::renderStatusBarOverlay(const StatusBarOverlayPosition position) const {
  const bool drawBottom = SETTINGS.xtcStatusBarMode == PicoReadSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_BOTTOM &&
                          position == StatusBarOverlayPosition::Bottom;
  const bool drawTop = SETTINGS.xtcStatusBarMode == PicoReadSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_TOP &&
...
void XtcReaderActivity::renderPage() {
  ...
  if (SETTINGS.xtcStatusBarMode == PicoReadSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_TOP) {
