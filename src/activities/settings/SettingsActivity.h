...
struct SettingInfo {
  StrId nameId;
  SettingType type;
  uint8_t PicoReadSettings::* valuePtr = nullptr;
  ...
  static SettingInfo Enum(StrId nameId, uint8_t PicoReadSettings::* ptr, std::vector<StrId> values,
  ...
  static SettingInfo Value(StrId nameId, uint8_t PicoReadSettings::* ptr, const ValueRange valueRange,
                           const char* key = nullptr, StrId category = StrId::STR_NONE_OPT) {
    SettingInfo s;
    s.nameId = nameId;
