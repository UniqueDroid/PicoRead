...
void ButtonRemapActivity::render(RenderLock&&) {
  ...
  GUI.drawButtonHints(renderer, labelForHardware(PicoReadSettings::FRONT_HW_BACK),
                      labelForHardware(PicoReadSettings::FRONT_HW_CONFIRM),
                      labelForHardware(PicoReadSettings::FRONT_HW_LEFT),
                      labelForHardware(PicoReadSettings::FRONT_HW_RIGHT));
...
const char* ButtonRemapActivity::getHardwareName(const uint8_t buttonIndex) const {
  switch (buttonIndex) {
    case PicoReadSettings::FRONT_HW_BACK:
      return tr(STR_HW_BACK_LABEL);
    case PicoReadSettings::FRONT_HW_CONFIRM:
      return tr(STR_HW_CONFIRM_LABEL);
    case PicoReadSettings::FRONT_HW_LEFT:
      return tr(STR_HW_LEFT_LABEL);
    case PicoReadSettings::FRONT_HW_RIGHT:
