...
void StatusBarSettingsActivity::onEnter() {
  ...
  if (SETTINGS.statusBarTitle >= PROGRESS_BAR_THICKNESS_ITEMS) {
    SETTINGS.statusBarTitle = PicoReadSettings::STATUS_BAR_PROGRESS_BAR_THICKNESS::PROGRESS_BAR_NORMAL;
  }

  if (SETTINGS.statusBarTitle >= TITLE_ITEMS) {
    SETTINGS.statusBarTitle = PicoReadSettings::STATUS_BAR_TITLE::HIDE_TITLE;
  }

  if (SETTINGS.xtcStatusBarMode >= XTC_STATUS_BAR_ITEMS) {
    SETTINGS.xtcStatusBarMode = PicoReadSettings::XTC_STATUS_BAR_MODE::XTC_STATUS_BAR_HIDE;
  }
...
void StatusBarSettingsActivity::render(RenderLock&&) {
  ...
  std::string title;
  if (SETTINGS.statusBarTitle == PicoReadSettings::STATUS_BAR_TITLE::BOOK_TITLE) {
