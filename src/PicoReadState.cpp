...
constexpr char STATE_FILE_BIN[] = "/.picoread/state.bin";
constexpr char STATE_FILE_JSON[] = "/.picoread/state.json";
constexpr char STATE_FILE_BAK[] = "/.picoread/state.bin.bak";
}  // namespace

PicoReadState PicoReadState::instance;

bool PicoReadState::isRecentSleep(uint16_t idx, uint8_t checkCount) const {
...
void PicoReadState::pushRecentSleep(uint16_t idx) {
...
bool PicoReadState::loadFromBinaryFile() {
  HalFile inputFile;
