...
// PicoRead theme metrics: identical to BaseMetrics except a shorter "Continue
// Reading" cover tile, which frees up vertical room for the 2-column tile grid
// below it (see PicoReadTheme::drawButtonMenu).
