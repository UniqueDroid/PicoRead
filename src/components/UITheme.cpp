...
UITheme::UITheme() {
  auto themeType = static_cast<PicoReadSettings::UI_THEME>(SETTINGS.uiTheme);
  setTheme(themeType);
}
...
void UITheme::setTheme(PicoReadSettings::UI_THEME type) {
  switch (type) {
    case PicoReadSettings::UI_THEME::CLASSIC:
      LOG_DBG("UI", "Using Classic theme");
      currentTheme = std::make_unique<BaseTheme>();
      currentMetrics = &BaseMetrics::values;
      break;
    case PicoReadSettings::UI_THEME::LYRA:
      LOG_DBG("UI", "Using Lyra theme");
      currentTheme = std::make_unique<LyraTheme>();
      currentMetrics = &LyraMetrics::values;
      break;
    case PicoReadSettings::UI_THEME::ROUNDEDRAFF:
      LOG_DBG("UI", "Using RoundedRaff theme");
      currentTheme = std::make_unique<RoundedRaffTheme>();
      currentMetrics = &RoundedRaffMetrics::values;
      break;
    case PicoReadSettings::UI_THEME::LYRA_3_COVERS:
...
int UITheme::getStatusBarHeight() {
  ...
  const bool showStatusBar =
      ...
      SETTINGS.statusBarClock != PicoReadSettings::STATUS_BAR_CLOCK_MODE::STATUS_BAR_CLOCK_HIDE;
  const bool showProgressBar =
      SETTINGS.statusBarProgressBar != PicoReadSettings::STATUS_BAR_PROGRESS_BAR::HIDE_PROGRESS;
