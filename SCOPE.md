# Project Vision & Scope: PicoRead

The goal of PicoRead is to create an efficient, open-source reading experience for the Xteink X4. We believe a
...
*These features align with PicoRead's goals but are impractical on the current hardware or produce poor UX.*
...
While I appreciate the desire to add new and exciting features to PicoRead, PicoRead is designed to be
