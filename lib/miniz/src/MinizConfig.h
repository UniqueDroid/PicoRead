/* PicoRead only needs miniz's low-level streaming inflate (tinfl). The
...
// picoread_ (NOT freeink_) so a future branch that links FreeInkBook's
// identically-renamed copy does not collide.
#define tinfl_decompress picoread_tinfl_decompress
#define tinfl_decompress_mem_to_heap picoread_tinfl_decompress_mem_to_heap
#define tinfl_decompress_mem_to_mem picoread_tinfl_decompress_mem_to_mem
#define tinfl_decompress_mem_to_callback picoread_tinfl_decompress_mem_to_callback
#define mz_crc32 picoread_mz_crc32
#define mz_adler32 picoread_mz_adler32
#define mz_free picoread_mz_free
