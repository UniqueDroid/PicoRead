/* bidiclasses.t — bidi class table for PicoRead Hebrew/English epub.
 *
 * Coverage rationale:
 *   Hebrew + English is the primary target. However, PicoRead renders
 ...
 *   scripts PicoRead's fonts don't support (CJK, Arabic, Devanagari, etc.)
...
/* ── Cyrillic (L) ────────────────────────────────────────────────────── */
/* Required: PicoRead supports Russian, Ukrainian, Bulgarian, etc.
...
/* Covers accented chars for Vietnamese, Welsh, Romanian, etc.
   Not currently rendered by PicoRead fonts, but costs only 2 table rows. */
{0x1E00, 0x1EFF, L},
