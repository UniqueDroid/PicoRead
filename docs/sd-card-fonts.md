...
PicoRead supports loading additional fonts from the SD card, including fonts
...
1. Connect your PicoRead reader to Wi-Fi
...
3. Insert the SD card and power on your PicoRead reader
